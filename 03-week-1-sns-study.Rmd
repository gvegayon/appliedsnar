...
<!-- with( -->
<!--   indeg_nom_cor, -->
<!--   mean((indeg - mean(indeg)) * (nom_avg - mean(nom_avg))) / -->
<!--     sqrt(var(indeg)*var(nom_avg)) -->
<!--   ) -->
<!-- ``` -->
...
We can get rid of these using the `igraph::-.igraph`, and re-run our ERGM

```{r 03-ergms-intergraph2, cache=TRUE}
# Creating the new network
...
# Running a simple ergm (only fitting edge count)
ans0 <- ergm(network_111 ~ edges + nodematch("hispanic") + +gwesp(fixed=T), control = control.ergm(seed = 1))
summary(ans0)
