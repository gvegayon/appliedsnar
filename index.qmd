...
description: "Preface to Applied Network Science with R, a free and fully reproducible book of R examples for analyzing social, biological, and other networked systems."
---
...
Starting in mid-2023, I have been using AI to help me write this book. Mainly, I use a combination of [GitHub co-pilot](https://github.com/features/copilot){target="_blank"}, which aids with code and text, and [Grammarly](https://grammarly.com){target="_blank"}, which aids with grammar and style. AI's role has been to help me write faster, but it has not been involved in the book's conceptualization or the development of the methods presented here.
