...
description: "R basics for network analysis: getting R from CRAN, choosing between RStudio and VS Code, and installing packages with install.packages and devtools."
---
