...
R [@R] is a programming language oriented to statistical computing. In the social network community, R has become the *de facto* due to the large number of packages available for network analysis. A good reference book for both novice and advanced users is ["The Art of R programming"](https://nostarch.com/artofr.htm) @Matloff2011[^matlof].
