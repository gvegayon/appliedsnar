---
description: "Stochastic Actor-Oriented Models (SAOMs), also known as Siena models, which describe network dynamics from the actors' probabilistic choice perspective."
---
