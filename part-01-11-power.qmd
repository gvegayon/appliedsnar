---
description: "Power calculation for network studies using simulation in R, including spillover effects in egocentric studies and estimating the required sample size."
---

# Power calculation in network studies

In survey and study design, calculating the required sample size is critical. Nowadays, tools and methods for calculating the required sample size abound; nonetheless, sample size calculation for studies involving social networks is still underdeveloped. This chapter will illustrate how we can use computer simulations to estimate the required sample size. Chapter @sec-part2-power provides a general overview of power analysis.
...
As we discuss in @sec-part2-power, it is always a good idea to encapsulate the simulation into a function:
...
As shown in Chapter @sec-part2-power, we can use a linear regression model to predict sample size as a function of statistical power:
