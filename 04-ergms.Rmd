...
For more details see [@Snijders2002], and [@Wang2009] provides a nice comparison between the algorithm used in `ergm` and in `PNet` (which is the same as the one used in `RSiena`).
