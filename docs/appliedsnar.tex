...
For more details see (; Admiraal and Handcock
\protect\hyperlink{ref-admiraal2006}{2006}). (Snijders
\protect\hyperlink{ref-Snijders2002}{2002}) provides details on the
algorithm used by PNet (which is the same as the one used in
\texttt{RSiena}), and (Wang et al.
\protect\hyperlink{ref-Wang2009}{2009}) a short discussion on
...
\begin{verbatim}
## + 1/2638 edge from c69bb8d (vertex names):
## [1] 1110111->1110111
\end{verbatim}
