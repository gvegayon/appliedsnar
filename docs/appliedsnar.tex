...
\begin{verbatim}
## + 1/2638 edge from b998a61 (vertex names):
## [1] 1110111->1110111
\end{verbatim}
...
\NormalTok{) }\OperatorTok{|}\ErrorTok{>}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{, }\DataTypeTok{caption =} \StringTok{"Rejection rate (%)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{step-3-simulate-a-graph}{%
\chapter{Step 3: Simulate a graph}\label{step-3-simulate-a-graph}}

net\_sim \textless{}- simulate
...
\begin{equation}
{\mathbb{P}\left(X=x\vphantom{Y=y}\;\right|\left.\vphantom{X=x}Y=y\right)} = \frac{{\mathbb{P}\left(Y=y\vphantom{X=y}\;\right|\left.\vphantom{Y=y}X=y\right)}{\mathbb{P}\left(X=x\right) }}{{\mathbb{P}\left(Y=y\right) }}
\end{equation}
...
\begin{equation}
r = \min\left(1, \frac{{\mathbb{P}\left(\theta'\vphantom{D}\;\right|\left.\vphantom{\theta'}D\right)}}{{\mathbb{P}\left(\theta\vphantom{D}\;\right|\left.\vphantom{\theta}D\right)}}\right)
\end{equation}
...
\[
\min\left(1, \frac{{\mathbb{P}\left(D\vphantom{\theta'}\;\right|\left.\vphantom{D}\theta'\right)}{\mathbb{P}\left(\theta'\right) }{\mathbb{P}\left(\theta'\vphantom{\theta}\;\right|\left.\vphantom{\theta'}\theta\right)}}{{\mathbb{P}\left(D\vphantom{\theta}\;\right|\left.\vphantom{D}\theta\right)}{\mathbb{P}\left(\theta\right) }{\mathbb{P}\left(\theta\vphantom{\theta'}\;\right|\left.\vphantom{\theta}\theta'\right)}}\right)
\]
...
\item
  ...
  \item
    ...
    \[
     r = \min\left(1, \frac{{\mathbb{P}\left(s_0\vphantom{s_t,\theta_t}\;\right|\left.\vphantom{s_0}s_t,\theta_t\right)}{\mathbb{P}\left(\theta_t\right) }{\mathbb{P}\left(\theta^*\to\theta_t\right) }}{{\mathbb{P}\left(s_0\vphantom{s_{t-1},\theta_{t-1}}\;\right|\left.\vphantom{s_0}s_{t-1},\theta_{t-1}\right)}{\mathbb{P}\left(\theta_{t-1}\right) }{\mathbb{P}\left(\theta_{t}\to\theta^*\right) }}\right)
     \]
  \end{enumerate}
