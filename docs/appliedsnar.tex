...
\begin{verbatim}
## + 1/2638 edge from ca3262a (vertex names):
## [1] 1110111->1110111
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## + 1/4 vertex, from 25b463f:
## [1] 2
## 
## [[2]]
## + 2/4 vertices, from 25b463f:
## [1] 1 3
## 
## [[3]]
## + 3/4 vertices, from 25b463f:
## [1] 2 4 4
## 
## [[4]]
## + 2/4 vertices, from 25b463f:
...
\begin{Highlighting}[]
\CommentTok{# Design}
\NormalTok{n_sims    <-}\StringTok{ }\DecValTok{500} \CommentTok{# Number of simulations}
\NormalTok{n_a       <-}\StringTok{ }\DecValTok{5}   \CommentTok{# Number of alters}
\NormalTok{sizes     <-}\StringTok{     }\CommentTok{# Sizes to try}
\StringTok{  }\KeywordTok{seq}\NormalTok{(}\DataTypeTok{from =} \DecValTok{100}\NormalTok{, }\DataTypeTok{to =} \DecValTok{300}\NormalTok{, }\DataTypeTok{by =} \DecValTok{25}\NormalTok{)}
