...
\begin{verbatim}
## + 1/2638 edge from e91f429 (vertex names):
## [1] 1110111->1110111
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{awful-chains.png}
\caption{\label{fig:badconvergence}An example of a terrible ERGM (no convergence at all). Also, a good example of why running multiple chains can be useful}
\end{figure}
