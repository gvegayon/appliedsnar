...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{col_eversmk1 <-}\StringTok{ }\KeywordTok{V}\NormalTok{(ig_year1_}\DecValTok{111}\NormalTok{)}\OperatorTok{$}\NormalTok{eversmk1 }\OperatorTok{+}\StringTok{ }\DecValTok{1}
\NormalTok{col_eversmk1 <-}\StringTok{ }\KeywordTok{coalesce}\NormalTok{(col_eversmk1, }\DecValTok{3}\NormalTok{) }
\NormalTok{col_eversmk1 <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"steelblue"}\NormalTok{, }\StringTok{"tomato"}\NormalTok{, }\StringTok{"white"}\NormalTok{)[col_eversmk1]}
\end{Highlighting}
\end{Shaded}
...
similar to this \(n\) times), we just need t
...
\NormalTok{  )}
  ...
  \KeywordTok{plot}\NormalTok{(}
\NormalTok{    subnet,}
    \DataTypeTok{vertex.size     =} \KeywordTok{degree}\NormalTok{(subnet)}\OperatorTok{/}\DecValTok{10}\NormalTok{,}
    \DataTypeTok{vertex.label    =} \OtherTok{NA}\NormalTok{,}
    \DataTypeTok{edge.arrow.size =}\NormalTok{ .}\DecValTok{25}\NormalTok{,}
