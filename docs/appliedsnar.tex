...
--- (D. R. Hunter et al. \protect\hyperlink{ref-Hunter2008}{2008})
\end{quote}
...
\(N = 2^{n(n-1)}\) possible networks! (D. R. Hunter et al.
...
structures have also been developed. (D. R. Hunter et al.
...
\begin{verbatim}
## + 1/2638 edge from ddfe2f9 (vertex names):
## [1] 1110111->1110111
\end{verbatim}
