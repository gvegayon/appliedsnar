...
\begin{verbatim}
## + 1/2638 edge from aba784e (vertex names):
## [1] 1110111->1110111
\end{verbatim}
...
\CommentTok{## }
\CommentTok{##      Null Deviance: 3396  on 2450  degrees of freedom}
\CommentTok{##  Residual Deviance: 2542  on 2448  degrees of freedom}
\CommentTok{##  }
\CommentTok{## AIC: 2544  BIC: 2550  (Smaller is better. MC Std. Err. = 0)}
\CommentTok{## }
...
Here are the estimates (using the \texttt{texreg} R package for a prettier output)\footnote{After writing this example, it became apparent the presence of
  a couple of bugs in the ERGM package. First, the parameter estimate of the
  \texttt{Log(\textasciitilde{}b1star(2))} term is significantly off from the simulated value. And second,
...
edges & 2.53 & 4.62\\
\hline
Log\textasciitilde{}b1star2 & 0.84 & 2.82\\
\hline
\end{tabular}
