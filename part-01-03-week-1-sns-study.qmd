...
description: "A start-to-finish example of turning school survey data into a network in R: reading Stata files, building the network, computing descriptives, and visualizing it."
---
