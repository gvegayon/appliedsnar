...
description: "Exponential Random Graph Models (ERGMs) in R with the ergm package: model specification, estimation, MCMC diagnostics, convergence, and goodness of fit."
---
...
![Source: Hunter et al. (2008)](img/hunter2008.png){fig-alt="Two network diagrams from Hunter et al. (2008): (a) the samplike network, with directed ties between nodes drawn as colored circles, diamonds, and triangles, and (b) the faux.mesa.high network, with nodes colored and shaped by school grade, 7 through 12."}
...
![An example of a terrible ERGM (no convergence at all). Also, a good example of why running multiple chains can be useful](img/awful-chains.png){fig-align="center" fig-alt="MCMC diagnostics for a non-converging ERGM. Trace plots for the nodematch.eversmk1, gwesp, and gwesp.decay statistics show four chains drifting apart instead of mixing, and the matching density plots show four separate, non-overlapping modes."}
